...
class Cargoes(models.Model):
    ...
    sender_email = models.CharField(max_length=255, verbose_name="Email отправителя", blank=True, null=True)
    recipient_phone = models.CharField(max_length=20, verbose_name="Номер получателя", blank=True, null=True)
    recipient_fullname = models.CharField(max_length=255, verbose_name="ФИО получателя", blank=True, null=True)
    recipient_email = models.CharField(max_length=255, verbose_name="Email получателя", blank=True, null=True)
